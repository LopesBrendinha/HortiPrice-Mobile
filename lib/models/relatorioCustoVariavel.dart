...
class RelatorioCustoVariavel{
  ...
  factory RelatorioCustoVariavel.fromMap(String id, Map<String, dynamic> map) {
    return RelatorioCustoVariavel(
      id: id,
      margem: map['margem'],
