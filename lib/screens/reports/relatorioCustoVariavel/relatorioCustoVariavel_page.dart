...
class RelatoriocustovariavelPage extends StatefulWidget {
  const RelatoriocustovariavelPage({super.key});

  @override
  State<RelatoriocustovariavelPage> createState() =>
      _RelatoriocustovariavelPageState();
}

class _RelatoriocustovariavelPageState
    extends State<RelatoriocustovariavelPage> {
  @override
